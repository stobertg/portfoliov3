...
export const HorseBackLegs = ({ position }:LegProps) => {
  return(
    ...
    <LegsWrap {...{ position }}>
          ...
          <path className="st0" d="M0.1,29c0,0-4-29,39-29s50,27,47,35s-11,35-11,35c-5,13-7,40-4.9,48.3c0.9,3.3,2.7,4.7,2.8,5.6
			...
			<LegBottom>
				<div className="horse__leg--hind-mid">
					<svg viewBox="0 0 9.1 40.4">
						<path d="M0.7,19C1.2,15.1,1.6,6.6,1.2,4.5C1,3.7,0.8,2.9,0.5,2c0,0,0.6-2,3.6-2c4.9,0,4.9,2,4.9,2c0,0.4,0,1,0,1.6 C9,9,8.7,20.9,
              9,23.4l0,17H2c0,0-2-4-2-8L0.7,19z"
            />
					</svg>
				</div>
