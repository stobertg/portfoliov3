...
import AirplaneBody from './_Body';
import AirplaneBlades from './_Blades';
import AirplaneWheels from './_Wheels';
import SquibbleOne from './_squibbleOne';
import SquibbleTwo from './_squibbleTwo';
